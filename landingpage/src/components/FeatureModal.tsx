          ...
          sections: [
            {
              ...
              content: (
                t(`features.robot_tech_content`) ||
                `• High-precision LiDAR sensor for 3D mapping
...
• Battery life: Approximately 2 hours`
            ...
            },
            {
              ...
              content: (
                t(`features.robot_safety_content`) ||
          ...
          sections: [
            {
              ...
              content: (
                t(`features.ar_devices_content`) ||
                `• iPhone (ARKit compatible)
...
• Magic Leap 2`
            ...
            },
            {
              ...
              content: (
                t(`features.ar_game_content`) ||
                `• Various treasure chest rarities
• Time attack mode
• Cooperative play
• Seasonal events`
              ).replace(/\\n/g, '\n'),
          ...
          sections: [
            {
              ...
              content: (
                t(`features.ai_process_content`) ||
                `• Capture location features with image recognition
...
• Choose from multiple candidates`
            ...
            },
            {
              ...
              content: (
                t(`features.ai_customize_content`) ||
                `• Art style selection
          ...
          sections: [
            {
              ...
              content: (
                t(`features.nft_blockchain_content`) ||
...
• Tradeable on OpenSea`
            ...
            },
            {
              ...
              content: (
                t(`features.nft_benefits_content`) ||
                `• Access to exclusive collections
• Community voting rights
• Real event invitations
• Potential future revenue sharing`
              ).replace(/\\n/g, '\n'),
            },
          ],
        };
